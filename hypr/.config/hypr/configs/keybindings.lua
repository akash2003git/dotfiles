...
-- Screenshots: area (SUPER+P) or full screen (SUPER+SHIFT+P), then annotate/save/copy with satty
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/screenshot.sh area"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/screenshot.sh screen"))
